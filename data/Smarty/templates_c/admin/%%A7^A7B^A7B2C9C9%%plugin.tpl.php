...
smarty_core_load_plugins(array('plugins' => array(array('function', 't', 'ownersstore/plugin.tpl', 36, false),array('modifier', 'script_escape', 'ownersstore/plugin.tpl', 122, false),array('modifier', 'sfGetErrorColor', 'ownersstore/plugin.tpl', 135, false),array('modifier', 'h', 'ownersstore/plugin.tpl', 135, false),array('modifier', 'default', 'ownersstore/plugin.tpl', 171, false),)), $this); ?>
...
<script type="text/javascript">//<![CDATA[
    $(function() {
        ...
        $('input[id^=plugin_enable]').change(function(event) {
            ...
            if(mode === 'disable') {
                result = window.confirm('<?php echo smarty_function_t(array('string' => "tpl_Do you want to void the plug-in?_01",'escape' => 'j'), $this);?>
');
                if(result === false) {
                    $(event.target).attr("checked", "checked");
                }
            } else if(mode === 'enable') {
                result = window.confirm('<?php echo smarty_function_t(array('string' => "tpl_Do you want to activate the plug-in?_01",'escape' => 'j'), $this);?>
');
                if(result === false) {
    ...
    function remoteException(XMLHttpRequest, textStatus, errorThrown) {
        alert('<?php echo smarty_function_t(array('string' => "tpl_An error occurred during transmission._01",'escape' => 'j'), $this);?>
');
    }
     ...
     */
    function install() {
        if (window.confirm('<?php echo smarty_function_t(array('string' => "tpl_Do you want to install the plug-in?_01",'escape' => 'j'), $this);?>
')){
    ...
    function uninstall(plugin_id, plugin_code) {
        if (window.confirm('<?php echo smarty_function_t(array('string' => "tpl_Data that has been erased cannot be restored.Do you want to delete the plug-in?_01",'escape' => 'j'), $this);?>
')){
    ...
    function update(plugin_id, plugin_code) {
        if (window.confirm('<?php echo smarty_function_t(array('string' => "tpl_Do you want to update the plug-in?_01",'escape' => 'j'), $this);?>
')){
...
<div id="system" class="contents-main">
    <h2><?php echo smarty_function_t(array('string' => "tpl_Plug-in registration_01"), $this);?>
</h2>
    <table class="form">
        <tr>
            <th><?php echo smarty_function_t(array('string' => "tpl_Plug-in<span class='attention'> *</span>_01",'escape' => 'none'), $this);?>
</th>
            <td>
...
<?php endif; ?>">
                <a class="btn-action" href="javascript:;" onclick="install(); return false;"><span class="btn-next"><?php echo smarty_function_t(array('string' => 'tpl_Install_01'), $this);?>
</span></a>
            </td>
        </tr>
    </table>
    ...
    <!--▼プラグイン一覧ここから-->
    <h2><?php echo smarty_function_t(array('string' => "tpl_Plug-in list_01"), $this);?>
</h2>
    <?php if (count ( ((is_array($_tmp=$this->_tpl_vars['plugins'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) ) > 0): ?>
        ...
        <table class="system-plugin" width="900">
            ...
            <col width="13%" />
            <tr>
                <th colspan="2"><?php echo smarty_function_t(array('string' => 'tpl_Explanation of functions_01'), $this);?>
</th>
                <th><?php echo smarty_function_t(array('string' => 'tpl_Priority_01'), $this);?>
</th>
            </tr>
...
','author_site_url','620','760'); return false;"><?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['plugin']['author'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('default', true, $_tmp, '-') : smarty_modifier_default($_tmp, '-')))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
                        ...
                        <div>
                            <span class="ec_cube_version"><?php echo smarty_function_t(array('string' => "tpl_Compatible EC-CUBE version :_01"), $this);?>
<?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['plugin']['compliant_version'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('default', true, $_tmp, '-') : smarty_modifier_default($_tmp, '-')))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
</span><br/>
...
', 'load', 615, 400);return false;"><?php echo smarty_function_t(array('string' => "tpl_Plug-in settings_01"), $this);?>
</a>&nbsp;|&nbsp;
                                <?php else: ?>
                                    <span><?php echo smarty_function_t(array('string' => "tpl_Plug-in settings_01"), $this);?>
&nbsp;|&nbsp;</span>
                                <?php endif; ?>
                            <!-- アップデート -->
...
"><?php echo smarty_function_t(array('string' => 'tpl_Update_02'), $this);?>
</a>&nbsp;|&nbsp;
                            <!-- 削除 -->
...
" id="login_memory" checked="checked"><?php echo smarty_function_t(array('string' => 'tpl_Enabled_01'), $this);?>
</input></label><br/>
                                <?php else: ?>
...
" id="login_memory"><?php echo smarty_function_t(array('string' => 'tpl_Enable_01'), $this);?>
</input></label><br/>
                                <?php endif; ?>
...
, '<?php echo ((is_array($_tmp=$this->_tpl_vars['plugin']['plugin_code'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
'); return false;"><span class="btn-next"><?php echo smarty_function_t(array('string' => 'tpl_Update_02'), $this);?>
</span></a>
                                </div>
                        </div>
                </td>
...
, '<?php echo ((is_array($_tmp=$this->_tpl_vars['plugin']['plugin_code'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
'); return false;"><span class="btn-next"><?php echo smarty_function_t(array('string' => 'tpl_Change_01'), $this);?>
</span></a><br/>
    ...
    <?php else: ?>
        <span><?php echo smarty_function_t(array('string' => "tpl_There are no plug-ins registered._01"), $this);?>
</span>
    <?php endif; ?>
</div>
</form>