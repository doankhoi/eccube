<?php /* Smarty version 2.6.26, created on 2015-09-14 06:20:17
         compiled from D:%5CWeb%5CServerHost%5Chtdocs%5Ceccube%5Chtml/../data/Smarty/templates/default_en-US/frontparts/bloc/calendar.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'D:\\Web\\ServerHost\\htdocs\\eccube\\html/../data/Smarty/templates/default_en-US/frontparts/bloc/calendar.tpl', 25, false),)), $this); ?>
...
img/title/icon_bloc_calender.gif" alt="Calendar" /><span class="title">Calendar</span></h2>
...
/<?php echo ((is_array($_tmp=$this->_tpl_vars['arrCal'][$this->_sections['cnt']['index']]['month'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
 (Holidays)</caption>
                    ...
                    <?php if (((is_array($_tmp=$this->_tpl_vars['arrCal'][$this->_sections['cnt']['index']]['first'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?>
                        ...
                        <?php elseif (((is_array($_tmp=$this->_tpl_vars['arrCal'][$this->_sections['cnt']['index']]['holiday'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?>
                            <td class="off<?php if (((is_array($_tmp=$this->_tpl_vars['arrCal'][$this->_sections['cnt']['index']]['today'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?> today<?php endif; ?>"><?php echo ((is_array($_tmp=$this->_tpl_vars['arrCal'][$this->_sections['cnt']['index']]['day'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
</td>
                        <?php else: ?>
                            <td<?php if (((is_array($_tmp=$this->_tpl_vars['arrCal'][$this->_sections['cnt']['index']]['today'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?> class="today"<?php endif; ?>><?php echo ((is_array($_tmp=$this->_tpl_vars['arrCal'][$this->_sections['cnt']['index']]['day'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
</td>
                        <?php endif; ?>
                ...
                <?php endif; ?>
            <?php endfor; endif; ?>
            <p class="information">* Holidays are indicated in red</p>
        </div>
